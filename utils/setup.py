...
NUM_CLASSES_DICT = {'imagenette':10,'imagenet':1000,'flowers102':102,'cifar':10,'cifar100':100,'svhn':10,'gtsrb':43}
...
def get_model(model_name,dataset_name,model_dir, ablation_size=19, ablation_type='column'):
    ...
    # elif 'mae_finetuned_vit_base' in model_name:
        ...
        model = timm.create_model('vit_base_patch16_224.mae', pretrained=timm_pretrained)
